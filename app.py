...
ui.page_opts(title="Jaya's PyShiny Express: Live Data From Nebraska", fillable=True, )
...
with ui.sidebar(open="open"):
    ui.h3("Weather for Omaha, NE", class_="text-center", style="color:navy")
    ui.p(
        "A demonstration of real-time temperature readings in Omaha",
        class_="text-center",
    )
    ui.hr()
    ui.h6("Helpful Links:")
    ui.a(
        "Jaya's GitHub Source",
        href="https://github.com/Jaya-srini/cintel-05-cintel.git", 
        target="_blank",
    )
